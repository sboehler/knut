...
|   Portfolio   |            |      1,025 |        989 |        856 |        984 |
|               |            |            |            |            |            |
| Total         |     10,000 |     12,825 |     15,116 |     14,983 |     15,111 |
+---------------+------------+------------+------------+------------+------------+
| Equity        |            |            |            |            |            |
|   Equity      |     10,000 |     10,003 |     10,003 |     10,003 |     10,003 |
|   Valuation   |            |            |            |            |            |
|     Portfolio |            |         26 |        -10 |       -143 |        -15 |
|               |            |            |            |            |            |
| Income        |            |            |            |            |            |
...
+-----------------+------------+------------+------------+------------+------------+------------+
| Assets          |            |            |            |            |            |            |
|   BankAccount   |            |     10,324 |     12,172 |     14,655 |     14,716 |     14,506 |
|   Portfolio     |            |            |      1,058 |      1,026 |        892 |      1,010 |
|                 |            |            |            |            |            |            |
| Total           |            |     10,324 |     13,230 |     15,680 |     15,608 |     15,516 |
+-----------------+------------+------------+------------+------------+------------+------------+
| Equity          |            |            |            |            |            |            |
|   Equity        |            |     10,324 |     10,327 |     10,327 |     10,327 |     10,327 |
|   Valuation     |            |            |            |            |            |            |
|     BankAccount |            |            |         -5 |        127 |        188 |        -22 |
|     Portfolio   |            |            |         29 |         -3 |       -136 |        -18 |
|                 |            |            |            |            |            |            |
| Income          |            |            |            |            |            |            |
...
+---------------+------------+------------+------------+------------+
| Assets        |            |            |            |            |
|   Portfolio   |        900 |        -36 |       -132 |        126 |
|               |            |            |            |            |
| Total         |        900 |        -36 |       -132 |        126 |
+---------------+------------+------------+------------+------------+
| Equity        |            |            |            |            |
|   Equity      |        874 |            |            |            |
|   Valuation   |            |            |            |            |
|     Portfolio |         26 |        -36 |       -132 |        126 |
|               |            |            |            |            |
| Total         |        900 |        -36 |       -132 |        126 |
+---------------+------------+------------+------------+------------+
| Delta         |            |            |            |            |
